...
#define vn_has_cached_data(VP)    vnode_hasdirtyblks(VP)
...
extern struct vnode *  dnlc_lookup(struct vnode *, const char *);

extern int  dnlc_update(struct vnode *, const char *, struct vnode *);

extern int  dnlc_remove(struct vnode *, const char *);
